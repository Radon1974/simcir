...
simcir.$ = function() {
  ...
  var fn = {
    ...
    remove : function() {				//удалить устройство и связи (удалить из кэша)
      if (this.parentNode) { this.parentNode.removeChild(this); }
      removeCache(this);
      return this;
    },
    detach : function() {				//удалить связи
      if (this.parentNode) { this.parentNode.removeChild(this); }
      return this;
    },
    ...
    children : function(selector) {		//добавление дочерних элементов
      var elms = [];
...
//------Создание контроллера------
  var createDeviceController = function(device) {
	...
	//Создание выходной точки контроллера
